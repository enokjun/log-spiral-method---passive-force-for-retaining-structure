...
elseif analysisMethod == 1
    ...
    Pp = crit_summaryData(10);

    Lm_s = H/3;
    Lm_q = H/2;
    Lm_c = H/2;

    sumM_ptA = Pp_s*Lm_s + Pp_q*Lm_q + Pp_c*Lm_c;
    Lm = sumM_ptA/Pp;

    final_summaryData = [crit_summaryData(1:6), Pp_s, Lm_s, Pp_q, Lm_q, Pp_c, Lm_c, Pp, Lm, sumM_ptA];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if analysisMethod == 0
    dlmwrite(strcat('CEE484_HW3_summary Data of Log Spiral Passive_drained.csv'), final_summaryData, 'delimiter', ',', 'precision', significantFigure);
...
elseif analysisMethod == 1
    dlmwrite(strcat('CEE484_HW3_summary Data of Log Spiral Passive_undrained.csv'), final_summaryData, 'delimiter', ',', 'precision', significantFigure);
